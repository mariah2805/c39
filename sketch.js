...
function draw() {
  ...
  if (gameState===PLAY){
   ...
   console.log(kangaroo.y)
    ...
    //se algum obstaculo toca no canguru
    //da play no som de colisão
    //muda o estado do jogo para END
    ...
    //se o canguru colidir com algum vegetal
    //adicione mais 1 score
    // destroi o vegetal
    ...
    // if(shrubsGrouisTouching(kangaroo)){
    //   score = score + 1;
    //   shrubsGroup.destroyEach();
    // }
